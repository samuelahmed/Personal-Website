      ...
      <main className='bg-white px-10 dark:bg-gray-900'>
        <section className="h-screen">
          <nav className='py-10 flex justify-between'>
            <h1 className='text-xl font-customFont'>Samuel Duval</h1>
          ...
          <div className='text-center p-10 pt-0'>
            ...
            <h3 className='text-2xl py-2'>Human | Political Scientist | Software Engineer</h3>
          ...
          <div className='text-3xl flex justify-center gap-7'>
            <AiFillLinkedin />
            <AiFillGithub />
          </div>
        </section>
